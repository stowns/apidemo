 ...
 * @param {String} options.name The name of the appliciton. This informs config
...
BusyBee.prototype.init = function (options) {
  ...
  this.conf = this.conf.retrieve(options);

  this.locator = new this.locator;
